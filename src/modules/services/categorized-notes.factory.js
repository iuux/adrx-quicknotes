...
module.exports = function(categoriesService, notesService, $rootScope) {
  ...
  $rootScope.$watch(function() { return categoriesService; }, function() {
    this.data = render();
    console.log('rerendered', this.data);
  }, true);
